...
cd "D:\Projects\Academy\BioMed_Final_Project\Files\Code\2_features_extraction"
) else (
call activate "opencv-envpython=3.6"
...
if %input_kind%==w (
	...
	echo 5. run script
	echo ...
	python feature_extraction_webcam.py --palsy_eye !eye! --tag 1 --face_frame 800 --pictures 1 --graphs 1 --r2 1 --times 0
)

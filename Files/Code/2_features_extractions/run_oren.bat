...
cd "C:\Users\orens\Documents\GitHub\BioMed_Final_Project\Files\Code\2_features_extractions"
) else (
call activate "opencv-envpython=3.6"
cd "C:\Users\אורן\Documents\GitHub\BioMed_Final_Project\Files\Code\2_features_extractions")
...
if %input_kind%==v (
	...
	echo 6. run script
	echo ...
	python feature_extraction_video.py --user OREN --input !input_path! --pictures 1 --graphs 1 --r2 1
)
if %input_kind%==w (
	:: 5. run scripts
	...
	echo 5. run script
	echo ...
	python feature_extraction_webcam.py --user OREN --palsy_eye !eye! --pictures 1 --graphs 1 --r2 1
)

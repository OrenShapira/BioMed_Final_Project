...
@echo off
echo User:   Oren
echo Script: real_time_blink_detection_x (x = webcam/video)
...
set script_path="Code\1_face_and_eye_detection\1_4_real_time_blink_detection\real_time_blink_detection_%input_kind%.py"
set input_path="Code\1_face_and_eye_detection\1_4_real_time_blink_detection\files\input\%input_kind%_%media_index%.mp4"
set output_path="Code\1_face_and_eye_detection\1_4_real_time_blink_detection\files\output\%input_kind%_%media_index%_out.mp4"

# USAGE
# python ..\real_time_blink_detection_webcam.py --shape-predictor shape_predictor_68_face_landmarks.dat --input ..\video_xx.mp4 --output ..\video_xx_out.mp4
...
while True:
    ...
    for rect in rects:
        ...
        cv2.putText(frame, "Blinks: {}".format(TOTAL), (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, COLOR, 2)
        cv2.putText(frame, "EAR: {:.2f}".format(ear), (300, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, COLOR, 2)
